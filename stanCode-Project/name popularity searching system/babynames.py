...
def add_data_for_name(name_data, year, rank, name):
    ...
    if name in name_data:
        # situation: male & female share the same year & name, choose the higher rank one
        if year in name_data[name]:
            if int(rank) < int(name_data[name][year]):
                name_data[name][year] = rank
        # situation: different year rank add to the same name
        else:
            name_data[name][year] = rank

    else:
        name_data[name] = rank_d
